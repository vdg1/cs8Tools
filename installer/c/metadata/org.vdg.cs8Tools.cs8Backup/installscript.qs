...
Component.prototype.createOperations = function()
{
    ...
    if (systemInfo.productType === "windows") {
        component.addOperation("CreateShortcut", "@TargetDir@/cs8Backup.exe", "@StartMenuDir@/cs8 Backup.lnk",
            "workingDirectory=@TargetDir@");
        component.addOperation("CreateShortcut", "@TargetDir@/cs8BackupSync.exe", "@StartMenuDir@/cs8 Backup Sync Tool.lnk",
            "workingDirectory=@TargetDir@");
    }
}
